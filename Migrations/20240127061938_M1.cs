...
namespace Lab4Cities.Migrations
{
    /// <inheritdoc />
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 625218, "BC" },
                    { 2, "Delta", 110848, "BC" },
                    { 3, "Kelowna", 132084, "BC" },
                    { 4, "Montréal", 3675219, "QC" },
                    { 5, "Sherbrooke", 151157, "QC" },
                    { 6, "Gatineau", 271569, "QC" },
                    { 7, "Ottowa", 994837, "ON" },
                    { 8, "Toronto", 2930023, "ON" },
                    { 9, "Hamilton", 579200, "ON" }
                });
